    ...
    <div style={{ background: '#F5F5F5' }} className="rounded-2xl overflow-hidden">
      ...
      {deleteWarningOpen && (
        <div className="fixed inset-0 z-[250] bg-black/70 flex items-end" onClick={() => setDeleteWarningOpen(false)}>
          <div className="bg-white w-full rounded-2xl px-4 pt-4" style={{ paddingBottom: 'calc(110px + env(safe-area-inset-bottom, 0px))' }} onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-3">
      ...
      {deleteConfirmOpen && (
        <div className="fixed inset-0 z-[250] bg-black/70 flex items-end" onClick={() => setDeleteConfirmOpen(false)}>
          <div className="bg-white w-full rounded-2xl p-4" style={{ paddingBottom: 'calc(110px + env(safe-area-inset-bottom, 0px))' }} onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-3">
