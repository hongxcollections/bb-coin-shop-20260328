  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      <div ref={flyerRef} className="max-w-2xl mx-auto py-6" style={{ fontFamily: "system-ui, sans-serif", background: "#fff" }}>
        ...
        <div className="mb-4">
          {round.coverImage ? (
            <div className="relative rounded-2xl overflow-hidden" style={{ margin: "0 5px" }}>
            ...
            <div className="px-4 pt-5 pb-4 rounded-2xl" style={{ margin: "0 5px", background: "linear-gradient(135deg, #f59e0b 0%, #ef4444 100%)" }}>
              {round.periodNumber && (
