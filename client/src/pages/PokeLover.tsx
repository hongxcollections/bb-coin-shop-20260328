...
export default function PokeLover() {
  ...
  return (
    <div className="min-h-screen pb-20" style={{ background: "linear-gradient(160deg, #a04000 0%, #c45200 40%, #a04000 100%)", color: "#fff" }}>
      <Header />
      ...
      <div className="max-w-lg mx-auto px-4 pt-4">
        ...
        {!imagePreview && (
          <div className="rounded-xl p-4 mt-2" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>
