                  ...
                  <div className="space-y-1.5">
                    {[
                      ...
                      },
                      {
                        ...
                        a: "進入拍賣頁，有兩種方式：\n• 直接出價：自己手動出，每次要高過目前最高價 + 最小加幅。\n• 代理出價（自動跟標）：輸入「最高願意俾嘅金額」，系統幫你自動跟標，每次只比對手高一口加幅，直到上限。\n結標前 X 分鐘內如有人出價，會自動延長 Y 分鐘防狙擊（X、Y 由商戶各自設定）。"
                      },
                      {
                        q: "3. 代理出價有咩會員等級限制？",
                        a: "🥉 銅牌：每月 3 次代理出價額度。\n🥈 銀牌：次數無限，但單次上限 HK$5,000。\n🥇 金牌 / 💎 VIP：解鎖次數和金額無上限。\n升級條件可入「會員權益」頁面睇。"
                      },
                      {
                        q: "4. 點樣成為商戶？(完整流程)",
                        a: "要完成 5 步：\n1. 登入 → 底部右下「更多功能」撳「商戶開通」填表。\n2. 等管理員 2 個工作天內批核申請。\n3. ⭐ 申請訂閱月費（必須，有不同計劃供商戶各自情況選擇，未訂閱商品上唔到架）。\n4. ⭐ 申請繳交保證金（必須，有不同計劃供商戶各自情況選擇；拍賣 / 出售商品後嘅傭金會由保證金內扣除，未繳交商品上唔到架）。\n5. 完成後入「商戶拍賣 / 商戶商品」撳「新增」開始自由上架。"
                      },
                      {
                        q: "5. 商戶要交幾多月費同保證金？",
                        a: "月費 / 年費：入「訂閱計劃 / Subscription Plans」頁揀適合你嘅 plan，不同計劃有不同上架配額同影片配額。\n保證金：有不同計劃選擇，當中嘅保證金計劃越高，拍賣傭金 / 商品出售傭金會相對較低，揀一個合適自己情況嘅就可以。\n相關資料都會喺商戶後台查看得到。"
                      },
                      {
                        q: "6. 保證金嘅用途？",
                        a: "每次拍賣 / 商品出售成交，網站會自動收取嘅平台佣金會直接由商戶嘅保證金餘額內扣返。\n保證金不足會被暫停商品上架功能；如保證金水平低過系統預設水平，商戶後台會出警示，記得入「商戶後台 → 保證金」頁面充值。"
                      },
                      {
                        q: "7. 點樣付款 / 收貨 / 交收？",
                        a: "會員得標 / 落單後：\n• 系統會通知買家同商戶。\n• 底部右下「更多功能」撳「出價紀錄」查看相關紀錄，可以一鍵 WhatsApp / Facebook Messenger 聯絡商戶（自動 copy 訊息 + 商品連結）。\n• 付款方式（FPS、銀行過數、面交等）同運費等等，請直接同商戶溝通。"
                      },
                      {
                        q: "8. 商戶如何申請傭金退款？",
                        a: "若拍賣成交後買家失蹤或拒絕付款，商戶可申請退還已扣除嘅傭金。每個拍賣只能提交一次申請。\n\n詳情：商戶後台 → 退傭申請 → 填寫原因。管理員收到申請後如無異議，傭金款項會加返入商戶保證金餘額內。"
                      },
                      {
                        q: "9. 主頁嘅「付費主打」係咩意思？",
                        a: "付費主打 係系統提供一個曝光率介面，喺頁面顯眼位置曝光，等更多用戶第一時間接觸到。\n呢個功能畀商戶以付費形式申請，有不同嘅曝光長短時間供選擇，選擇後自動喺保證金內扣除費用。"
                      },
                      {
                        q: "10. 忘記密碼點算？",
