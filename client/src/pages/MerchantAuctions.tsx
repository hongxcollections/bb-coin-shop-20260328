                  ...
                  <div className="flex gap-1.5 px-2.5 pb-2.5">
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        if (navigator.share) {
                          try {
                            toast.info("分享文字已複製，請在 Facebook 貼文框長按貼上", { duration: 4000 });
                            await navigator.share({ title: a.title, url: auctionUrl });
                          } catch {}
                        } else {
                          toast.info("分享文字已複製，請貼入 Facebook 帖子", { duration: 4000 });
