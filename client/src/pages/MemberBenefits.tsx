...
const BENEFITS: BenefitRow[] = [
  ...
  },
  {
    ...
    icon: <Zap className="w-4 h-4" />,
    benefit: "代理出價功能",
    detail: "設定您願意支付的最高金額，系統將自動代您出價，每次只出剛好超過對手的最低金額，直至達到您的上限。您無需時刻守候，系統為您守住領先位置。銅牌每月有限次數，銀牌單次有金額上限，金牌／VIP 完全無限制。",
    bronze: "限次數", silver: "有上限", gold: true, vip: true,
  },
  {
    category: "競標",
    icon: <Shield className="w-4 h-4" />,
    benefit: "匿名出價（隱藏身份）",
    detail: "出價時隱藏您的會員名稱，其他競爭者只會見到「匿名買家」，避免被熟客盯標或被人惡意加價。銅牌不可使用；銀牌視乎管理員設定；金牌／VIP 永遠可用，且預設打開。",
    bronze: false, silver: "視設定", gold: true, vip: true,
  },
  {
    category: "通知",
...
const LEVEL_DESCRIPTIONS: Record<MemberLevel, { title: string; desc: string; perks: string[] }> = {
  ...
  silver: {
    title: "銀牌藏家",
    desc: "進階收藏家的首選。在銅牌基礎上，額外享有優先出價通知 + 匿名出價權限，讓您在激烈競標中搶得先機又可隱藏身份。",
    perks: ["銅牌全部權益", "優先出價通知", "🕶️ 匿名出價（視設定）", "銀牌專屬橫幅", "銀牌尊榮徽章"],
  },
  gold: {
    title: "金牌資深藏家",
    desc: "資深藏家的象徵。除享有銀牌全部權益外，更獲得個人資料頁尊榮設計、無限次代理出價、永遠可匿名（預設打開），彰顯您的收藏品味與地位。",
    perks: ["銀牌全部權益", "🕶️ 匿名出價（預設打開）", "🤖 無限次代理出價", "個人頁尊榮設計", "金牌專屬橫幅", "金牌尊榮徽章"],
  },
  vip: {
    title: "💎 VIP 頂級藏家",
    desc: "臻品收藏家的最高榮耀。享有平台所有功能與尊榮待遇，包括優先客服支援、無限制代理／匿名出價，讓每一次競標體驗都無與倫比。",
    perks: ["金牌全部權益", "🕶️ 匿名出價無限制", "優先客服支援", "VIP 尊享橫幅", "💎 VIP 頂級徽章"],
  },
};
