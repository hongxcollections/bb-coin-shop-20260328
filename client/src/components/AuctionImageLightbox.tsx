...
export function AuctionImageLightbox({
  ...
  return (
    <div className="fixed inset-0 z-[70] bg-black flex flex-col">
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-2 bg-black text-white shrink-0 safe-area-top">
        ...
        {images.map((img, idx) => (
          <div key={idx} className="mb-0">
            ...
            <img
              ...
              style={{ display: "block" }}
            />
            {/* Per-image action bar: 讚好 | 分享 only (no 回應) */}
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="bg-gray-100 rounded-2xl px-3 py-2 inline-block max-w-[85%]">
                        ...
                        {!item.isAnonymous && user && item.userId === user.id && (
      ...
      {/* Fixed bottom input — same logic as AuctionFbPanel */}
