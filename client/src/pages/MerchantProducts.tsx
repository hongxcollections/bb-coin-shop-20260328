...
export default function MerchantProducts() {
  ...
  const [activeTab, setActiveTab] = useState<"products" | "orders" | "cards">(() => {
    const params = new URLSearchParams(window.location.search);
    if (params.get("tab") === "orders") return "orders";
    if (params.get("tab") === "cards") return "cards";
    return "products";
  });
      ...
      <div className="container max-w-lg mx-auto pt-4 pb-28 space-y-4">
        ...
        <div className="flex gap-1 bg-gray-100 rounded-xl p-1">
          ...
          <button onClick={() => setActiveTab("cards")}
            className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === "cards" ? "bg-white text-sky-700 shadow-sm" : "text-gray-500 hover:text-gray-700"}`}>
