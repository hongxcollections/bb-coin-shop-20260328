  ...
  if (copyPickerOpen && editGalleryId !== null) {
    ...
    return (
      <div className="fixed inset-0 z-50 bg-black/60 flex items-end" onClick={() => setCopyPickerOpen(false)}>
        <div className="w-full bg-white rounded-t-2xl p-4 max-h-[70vh] overflow-y-auto" style={{ paddingBottom: 'calc(80px + env(safe-area-inset-bottom, 0px))' }} onClick={e => e.stopPropagation()}>
    ...
    <div style={{ background: '#F5F5F5' }} className="rounded-2xl overflow-hidden">
      ...
      {deleteConfirmOpen && (
        <div className="fixed inset-0 z-[250] bg-black/70 flex items-end" onClick={() => setDeleteConfirmOpen(false)}>
          <div className="bg-white w-full rounded-t-2xl p-4" style={{ paddingBottom: 'calc(80px + env(safe-area-inset-bottom, 0px))' }} onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-3">
